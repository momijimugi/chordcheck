...
export const DEMO_PRESETS: DemoPreset[] = [
  {
    id: 'test1',
    name: 'Test 1: 基本コードトーン (C Major)',
    description: 'Cメジャーコード構成音 (C4, E4, G4) の基本ハーモニー。',
    expectedOutcome: 'C Majorが高確信度で検出され、全ノートがSAFEと判定されます。',
  },
  {
    id: 'test2',
    name: 'Test 2: 強拍コード外音の警告 (F#4 on C Major)',
    description: 'Cメジャー上で強拍に置かれた長いF#4（コード外音）。',
    expectedOutcome: 'F#4が明確な理由とともにWARNING / CHECKとして検出されます。',
  },
  {
    id: 'test3',
    name: 'Test 3: 経過音の許容 (E4 → F4 → G4)',
    description: 'Cメジャー上のメロディ（E4→F4→G4）で弱拍の短いF4。',
    expectedOutcome: 'F4が経過音（Passing Tone）として認識され、SAFE / INFOと判定されます。',
  },
  {
    id: 'test4',
    name: 'Test 4: 刺繍音の許容 (E4 → F4 → E4)',
    description: 'Cメジャー上のメロディ（E4→F4→E4）で弱拍の短いF4。',
    expectedOutcome: 'F4が刺繍音（Neighbor Tone）として認識され、SAFE / INFOと判定されます。',
  },
  {
    id: 'test5',
    name: 'Test 5: 先行動音の許容 (C Major → F Major)',
    description: '次小節のFメジャーへ転換する直前に先行して鳴るF4。',
    expectedOutcome: 'F4が先行動音（Anticipation）として認識され、INFOと判定されます。',
  },
  {
    id: 'test6',
    name: 'Test 6: キースイッチ自動除外 (Low Keyswitches)',
    description: '極低音（C-1, D-1）の奏法切替キースイッチを含むバイオリントラック。',
    expectedOutcome: 'キースイッチ検出アラートが表示され、音域除外によりコード誤推定を防止します。',
  },
  {
    id: 'test7',
    name: 'Test 7: 10トラック オーケストラ総合楽曲',
    description: 'フルート、弦楽器、金管、ピアノ等10トラックで構成された4小節の本格楽曲。',
    expectedOutcome: '多トラックのコード進行（Cmaj7-Am7-Dm7-G7）を推定し、怪しい音のみ的確に警告します。',
  },
];
